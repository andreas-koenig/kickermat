 ...
 * INCLUDE SECTION
 *----------------------------------------------------------------------------*/
#include "main.h" /* Include HAL interfaces generated by cube MX. */
#include "CO_driver.h"
...
*/
	...
	CANmodule->CANbaseAddress->Init.TimeSeg2=CAN_BS2_5TQ;
	CANmodule->CANbaseAddress->Init.TimeSeg1=CAN_BS1_12TQ;
